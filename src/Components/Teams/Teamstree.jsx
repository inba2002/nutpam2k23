...
import malathi from "../../Assets/Crew/dimensional/malathi.jpg";
import sharmila from "../../Assets/Crew/dimensional/sharmila.jpg";
import deena from "../../Assets/Crew/dimensional/Deena.jpg";
import anuj from "../../Assets/Crew/dimensional/anuj.jpeg";
import aravind from "../../Assets/Crew/dimensional/aravind.jpg";
...
import praba from "../../Assets/Crew/space/praba.jpeg";
import vidhya from "../../Assets/Crew/space/vidhya.jpeg";
import ragul from "../../Assets/Crew/space/ragul.jpg";
import pranav from "../../Assets/Crew/space/pranav.jpg";
import jawa from "../../Assets/Crew/space/jawahar.jpg";
import dhanushbk from "../../Assets/Crew/space/dhanush.jpg";
import vas from "../../Assets/Crew/space/vas.jpg";
...
const Teamstree = () => {
  ...
  const dime = [
    { image: malathi, name: "Malathi G", role: "Staff Coordinator" },
    { image: sharmila, name: "Sharmila", role: "Staff Coordinator" },
    { image: raj, name: "Raj Ronald Shaw", role: "Event Coordinator" },
    { image: aravind, name: "Aravindhan", role: "Event Coordinator" },
    { image: gopi, name: "Gopinathan S", role: "Event Coordinator" },
    { image: deena, name: "Deenu", role: "Event Coordinator" },
    { image: anuj, name: "Anuj Krishna J", role: "Event Coordinator" },
  ];

  const space = [
    { image: praba, name: "Prabahar Godwin James T", role: "Staff Coordinator" },
    { image: vidhya, name: "Vidhya", role: "Staff Coordinator" },
    { image: dhanushbk, name: "Dhanush B K", role: "Event Coordinator" },
    { image: ragul, name: "Ragul D", role: "Event Coordinator" },
    { image: pranav, name: "Pravnav M", role: "Event Coordinator" },
    { image: jawa, name: "Jawahar J", role: "Event Coordinator" },
    { image: vas, name: "Vasanth R", role: "Event Coordinator" },
  ];
  const astro = [
    { image: anu, name: "Anuradha C", role: "Staff Coordinator" },
    { image: kavi, name: "Kavinilavu", role: "Staff Coordinator" },
  ...
  return (
    <div className="w-full min-h-screen flex flex-wrap justify-center items-center gap-3 py-5 text-white">
      <div className="w-full flex items-center justify-center">
        <h1 className="font-mono md:text-[5rem] lg:text-[5rem] text-[3rem] text-center">
          NUTPAM ASTRONAUTS
        </h1>
      </div>
      <div className="w-full flex items-center justify-center">
      ...
      <div className="w-full flex items-center justify-center">
        <h1 className="font-mono md:text-[4rem] lg:text-[4rem] text-[3rem] text-center">
          Galactic Adventures
        </h1>
      </div>
      <div className="w-full flex items-center justify-center">
      ...
      <div className="w-full flex items-center justify-center">
        <h1 className="font-mono md:text-[3rem] lg:text-[3rem] text-[2rem] text-center">
          Dimensional Conquest Astronauts
        </h1>
      </div>
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-4 lg:gap-8 md:grid-cols-2 md:gap-8 place-items-center py-8 lg:px-8 px-5">
        {dime.map((item) => (
