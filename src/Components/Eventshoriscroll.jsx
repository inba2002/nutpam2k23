...
const desc=[
  ...
  "Celestal Pause is an musical fun based event , where you can enjoy your time with music.Celestical Pause is an musical fun based event , where you can enjoy your time with music",
...
const Eventshoriscroll = () => {
    ...
    const cards=[
        ...
        {navigation:"/celestialpause",image:eve5,head:"Celestial Pause",desc:"Celestial Pause is an musical fun based event , where you can enjoy your time with music."},
