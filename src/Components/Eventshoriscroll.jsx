...
const Eventshoriscroll = () => {
    ...
    const cards=[
        ...
        {image:eve2,head:"AISTRONOMY",desc:"AIstronomy is an Technical Event based on Artificial Intelligence and Machine Learning, which evaluates your knowledge in AI, ML and makes your mind to train like a Astro."},
        ...
        {image:eve4,head:"Pixel Legacy",desc:"Are you ready to embark on a cosmic design journey? Join us in this exciting UI design contest centered around the captivating theme of space exploration. Let your imagination soar among the stars as you craft innovative, user-centric solutions."},
        {image:eve5,head:"Pixel Legacy",desc:"Celestical Pause is an musical fun based event , where you can enjoy your time with music.Celestical Pause is an musical fun based event , where you can enjoy your time with music"},
        {image:eve6,head:"Celestial Pause",desc:"AstroCapture delves into life on land, capturing mesmerizing visuals to reveal the world in night mode."},
        ...
        {image:eve8,head:"Dimensional Conquest",desc:"Dimensional Conquest is an exciting Valorant Tournament that showcases the skills & teamwork of your squad. It provides an excellent platform for amateur & semi-pro players to compete, gain experience & potentially make a name for themselves in the competitive valorant scene."},
    ]
