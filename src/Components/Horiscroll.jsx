    ...
    <div className="bg-transparent">
      {/* <div className="flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center justify-center p-8 gap-8">
          ...
          <div className="w-full flex flex-col items-center justify-center"style={{backgroundImage:`url(${eve1})`,backgroundSize: "cover",}}>
          ...
          <div className="w-full flex flex-col items-center justify-center"style={{backgroundImage:`url(${eve2})`,backgroundSize: "cover",}}>
          <div className="text-justify bg-gradient-to-br from-white/20 to-white/0 backdrop-blur-lg p-4 m-8 flex flex-col items-center justify-center">
          ...
          <div className="w-full flex flex-col items-center justify-center"style={{backgroundImage:`url(${eve3})`,backgroundSize: "cover",}}>
          <div className=" text-justify bg-gradient-to-br from-white/20 to-white/0 backdrop-blur-lg p-4 m-8 flex flex-col items-center justify-center">
          ...
          <div className="w-full flex flex-col items-center justify-center"style={{backgroundImage:`url(${eve4})`,backgroundSize: "cover",}}>
          <div className=" text-justify bg-gradient-to-br from-white/20 to-white/0 backdrop-blur-lg p-4 m-8 flex flex-col items-center justify-center">
          ...
          <div className="w-full flex flex-col items-center justify-center"style={{backgroundImage:`url(${eve5})`,backgroundSize: "cover",}}>
          <div className=" text-justify bg-gradient-to-br from-white/20 to-white/0 backdrop-blur-lg p-4 m-8 flex flex-col items-center justify-center">
          ...
          <div className="w-full flex flex-col items-center justify-center"style={{backgroundImage:`url(${eve6})`,backgroundSize: "cover",}}>
          <div className=" text-justify bg-gradient-to-br from-white/20 to-white/0 backdrop-blur-lg p-4 m-8 flex flex-col items-center justify-center">
          ...
          <div className="w-full flex flex-col items-center justify-center"style={{backgroundImage:`url(${eve7})`,backgroundSize: "cover",}}>
          <div className=" text-justify bg-gradient-to-br from-white/20 to-white/0 backdrop-blur-lg p-4 m-8 flex flex-col items-center justify-center">
          ...
          <div className="w-full flex flex-col items-center justify-center"style={{backgroundImage:`url(${eve8})`,backgroundSize: "cover",}}>
          <div className=" text-justify bg-gradient-to-br from-white/20 to-white/0 backdrop-blur-lg p-4 m-8 flex flex-col items-center justify-center">
