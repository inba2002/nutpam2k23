  ...
  return (
    ...
    >
      ...
      <h1 className="text-end">
        Team Lead & Teammates are two separate participants, hence make sure not
        to give any wrong/same details.
      </h1>
      ...
      <div className="flex items-center justify-center p-10">
        <button className="btn  w-32 items-center justify-center hover:bg-white/10 hover:shadow-lg bg-white/25" type="submit">
          Submit
        </button>
      </div>
    </form>
